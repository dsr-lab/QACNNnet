...
from layer_encoder import custom_softmax
...
class MultiHeadAttention(Layer):
  ...
  def _build_attention(self, rank):
    ...
    self._softmax = custom_softmax.Softmax(axis=norm_axes)  # mixed_precision fix
  ...
  def _compute_attention(self,
    ...
    tf.cast(attention_scores, dtype=tf.float32)
    attention_scores = self._masked_softmax(attention_scores, attention_mask)
    tf.cast(attention_scores, dtype=tf.float16)
